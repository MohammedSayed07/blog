<header class="mt-16 text-center max-w-4xl mx-auto">
    <div class="max-w-xl mx-auto">
        ...
        <h2 class="inline-flex items-center mt-2">
            by Mohammed Sayed <img class="ml-1" src="/images/head.png" width="25" alt="head">
        </h2>

        <p class="text-sm mt-14">
            So I'm Learning all the time. Learning new technologies. Making new projects.
            I'm going to keep you guys up to speed with what's going on!
        </p>
        <div class="flex md:flex-row flex-col lg:justify-center lg:items-center lg:space-x-5 mt-8 space-y-2 lg:space-y-0">
            <div class="bg-gray-100 rounded-xl inline-flex items-center relative w-full">
                <div x-data="{ show: false }" class="w-full">
                    <button @click="show = !show" class="w-full py-3 pr-16 pl-4 text-sm font-semibold lg:inline-flex block text-left" @click.outside="show = false">
                        {{ isset($currentCategory) ? $currentCategory->name : 'Categories' }}
                        <svg class="absolute right-5 top-2.5 pointer-events-none"
                    ...
                    <div x-show="show" class="mt-1 bg-gray-100 py-2 absolute w-full z-40 rounded-xl" style="display: none;">
                        @foreach($categories as $category)
                            <a href="/categories/{{ $category->slug }}"
                               class="block text-left px-3 hover:bg-blue-500 hover:text-white
            ...
            <div class="bg-gray-100 rounded-xl inline-flex items-center relative">
                        <select class="appearance-none bg-transparent py-3 pr-14 pl-4 text-sm font-semibold focus-within:outline-none">
